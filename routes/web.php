...
use App\Http\Controllers\CMDB\TemplateController as CMDBTemplateController;
...
Route::get('/cmdb/template/download', [CMDBTemplateController::class, 'downloadTemplate'])->name('cmdb.template.download');